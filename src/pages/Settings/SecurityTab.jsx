...
import { updateUserInfoApi, logoutUserApi } from '~/redux/User/userSlide'
...
function SecurityTab() {
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      ...
      // Gọi API...
      toast.promise(dispatch(updateUserInfoApi({ current_password, new_password })), {
        loading: 'Updating...'
      }).then(res => {
        // Nếu thành công thì cập nhật lại giá trị trong form
        if (!res.error) {
          toast.success('Update new password successfully, please login again.')
          // Logout user
          // Gọi API...
